...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $tracking_number = trim($_POST['tracking_number']); // Recupera il codice di spedizione
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO tickets (cliente_id, titolo, descrizione, priorita) VALUES (?, ?, ?, ?)");
        $stmt->execute([$cliente_id, $tracking_number, $descrizione, $priorita]);
...
<body style="background-color: #f8f9fa;">
    ...
    <div class="container mt-5">
        <div class="card shadow p-4" style="max-width: 500px; margin: auto;">
            ...
            <form method="POST">
                <div class="mb-3">
                    <label class="form-label fw-bold">Inserisci Codice di Spedizione</label>
                    <input type="text" name="tracking_number" class="form-control" required autofocus>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-bold">Descrizione del Problema</label>
